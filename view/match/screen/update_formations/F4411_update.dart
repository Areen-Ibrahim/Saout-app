...
class FourFourOneOneUpdate extends StatefulWidget {
  ...
  @override
  _FourFourOneOneUpdateState createState() => _FourFourOneOneUpdateState();
}

class _FourFourOneOneUpdateState extends State<FourFourOneOneUpdate> {
  final UpdateMatchController updateMatchController = Get.put(UpdateMatchController());
  List<bool> isVisible = List.filled(11, false);
  @override
  void initState() {
    super.initState();
