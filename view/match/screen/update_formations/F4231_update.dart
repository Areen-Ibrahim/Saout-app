...
class FourTwoThreeOneUpdate extends StatefulWidget {
  ...
  @override
  _FourTwoThreeOneUpdateState createState() => _FourTwoThreeOneUpdateState();
}

class _FourTwoThreeOneUpdateState extends State<FourTwoThreeOneUpdate> {
    ...
    return Center(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            _buildPlayerSlot(context, 0), // مهاجم
            SizedBox(height: 36),
            // الصف الثاني (2 لاعبين)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: List.generate(2, (index) => _buildPlayerSlot(context, index + 1)),
            ),
            SizedBox(height: 36),
            // الصف الثالث (3 لاعبين)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: List.generate(3, (index) => _buildPlayerSlot(context, index + 3)),
            ),
            SizedBox(height: 36),
            // الصف الرابع (4 لاعبين)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: List.generate(4, (index) => _buildPlayerSlot(context, index + 6)),
            ),
            SizedBox(height: 36),
            // الصف الخامس (لاعب واحد)
            _buildPlayerSlot(context, 10), // حارس المرمى
          ],
        ),
      ),
    );
