...
class FourFourTwoUpdate extends StatefulWidget {
  ...
  @override
  _FourFourTwoUpdateState createState() => _FourFourTwoUpdateState();
}

class _FourFourTwoUpdateState extends State<FourFourTwoUpdate> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: List.generate(2, (index) => _buildPlayerSlot(context, index)),
            ),
            SizedBox(height: 36),
            // الصف الثاني (لاعبان)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: List.generate(2, (index) => _buildPlayerSlot(context, index + 2)),
            ),
            SizedBox(height: 36),
            // الصف الثالث (لاعب واحد)
