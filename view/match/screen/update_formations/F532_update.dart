...
class FiveThreeTwoUpdate extends StatefulWidget {
  ...
  @override
  _FiveThreeTwoUpdateState createState() => _FiveThreeTwoUpdateState();
}

class _FiveThreeTwoUpdateState extends State<FiveThreeTwoUpdate> {
    ...
    return Center(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // الصف الأول (2 لاعبين - حارس مرمى + لاعب واحد)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                _buildPlayerSlot(context, 0), // حارس المرمى
                _buildPlayerSlot(context, 1), // لاعب واحد
              ],
            ),
            SizedBox(height: 36),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: List.generate(3, (index) => _buildPlayerSlot(context, index + 7)),
            ),
            SizedBox(height: 36),
            // الصف الخامس (1 لاعب - المهاجم)
            Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                _buildPlayerSlot(context, 10), // مهاجم
              ],
            ),
          ],
        ),
