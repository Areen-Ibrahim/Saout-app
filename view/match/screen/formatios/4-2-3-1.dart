...
class FourTwoThreeOne extends StatelessWidget {
          ...
          children: [
            ...
            Obx(() {
              return GestureDetector(
                onTap: () => _showPlayerList(context, 0),
                child: Column(
                  children: [
                    selectedPlayerImages[0].value.isNotEmpty
                        ? CircleAvatar(
                      radius: 30,
                      backgroundImage: NetworkImage(selectedPlayerImages[0].value),
                    )
                        : Container(
                      width: 60,
                      height: 60,
                    ...
                    Text(
                      selectedPlayerNames[0].value,
                      style: TextStyle(color: Colors.white),
                    ),
                    Text(
                      selectedPlayerNumbers[0].value,
                      style: TextStyle(color: Colors.white),
                    ),
                  ],
                ),
            ...
            // الصف الثاني (2 لاعبين)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: List.generate(2, (index) {
                return Obx(() {
                  return GestureDetector(
                    onTap: () => _showPlayerList(context, index + 1),
                    child: Column(
                      children: [
                        selectedPlayerImages[index + 1].value.isNotEmpty
                            ? CircleAvatar(
                          radius: 30,
                          backgroundImage: NetworkImage(selectedPlayerImages[index + 1].value),
                        )
                            : Container(
                          width: 60,
                          height: 60,
                        ...
                        Text(
                          selectedPlayerNames[index + 1].value,
                          style: TextStyle(color: Colors.white),
                        ),
                        Text(
                          selectedPlayerNumbers[index + 1].value,
                          style: TextStyle(color: Colors.white),
                        ),
                      ],
                    ),
            ...
            Row(
              ...
              children: List.generate(3, (index) {
                return Obx(() {
                  return GestureDetector(
                    onTap: () => _showPlayerList(context, index + 3),
                    child: Column(
                      children: [
                        selectedPlayerImages[index + 3].value.isNotEmpty
                            ? CircleAvatar(
                          radius: 30,
                          backgroundImage: NetworkImage(selectedPlayerImages[index + 3].value),
                        )
                            : Container(
                          width: 60,
                          height: 60,
                        ...
                        Text(
                          selectedPlayerNames[index + 3].value,
                          style: TextStyle(color: Colors.white),
                        ),
                        Text(
                          selectedPlayerNumbers[index + 3].value,
                          style: TextStyle(color: Colors.white),
                        ),
                      ],
                    ),
            ...
            // الصف الرابع (4 لاعبين)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: List.generate(4, (index) {
                return Obx(() {
                  return GestureDetector(
                    onTap: () => _showPlayerList(context, index + 6),
                    child: Column(
                      children: [
                        selectedPlayerImages[index + 6].value.isNotEmpty
                            ? CircleAvatar(
                          radius: 30,
                          backgroundImage: NetworkImage(selectedPlayerImages[index + 6].value),
                        )
                            : Container(
                          width: 60,
                          height: 60,
                        ...
                        Text(
                          selectedPlayerNames[index + 6].value,
                          style: TextStyle(color: Colors.white),
                        ),
                        Text(
                          selectedPlayerNumbers[index + 6].value,
                          style: TextStyle(color: Colors.white),
                        ),
                      ],
                    ),
