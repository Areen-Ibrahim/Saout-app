...
import '../../../../controllers/controller_scout/controller_scout_auth/log_in_user_controller.dart';
import '../../../../core/color.dart';
import '../../../../core/next_button.dart';
import '../../../../core/password_field.dart';
import '../../../homePage/widget/text_title_add_player.dart';
import '../widget/text_form_login_widget.dart';



class LoginScoutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: TextTitleAddPlayer(text: 'Login as scout'),
...
// String username = 'alalighind@gmail.com'; // البريد الثابت
// String password = 'trny edau twbo qxux';   // كلمة المرور الخاصة بالبريد