...
class FourThreeThreeScout extends StatelessWidget {
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: List.generate(2, (index) => _buildPlayerSlot(index + 1)),
              ),
            ),
            SizedBox(height: 36),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: List.generate(2, (index) => _buildPlayerSlot(index + 3)),
            ),
            SizedBox(height: 36),
            _buildPlayerSlot(5),
            SizedBox(height: 36),
