...
class FourFourOneOneScout extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: List.generate(4, (index) => _buildPlayerSlot(index + 1)),
            ),
            SizedBox(height: 36),
            // الصف الثالث (4 لاعبين)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: List.generate(4, (index) => _buildPlayerSlot(index + 5)),
            ),
            SizedBox(height: 36),
            // الصف الرابع (مهاجمان)
            Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: List.generate(2, (index) => _buildPlayerSlot(index + 9)),
            ),
          ],
        ),
      ),
